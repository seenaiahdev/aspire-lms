      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto space-y-4 pr-1 pb-6">
        ...
        <div className="flex flex-col bg-white rounded-2xl border border-slate-200/90 shadow-sm overflow-hidden p-4 shrink-0 min-h-[350px]">
          ...
          <div className="flex-1 overflow-y-auto pt-3">
            ...
            {tab === 'discussion' && (
              <div className="relative h-full min-h-[220px] flex flex-col items-center justify-center p-6 text-center select-none bg-white rounded-2xl border border-slate-100 shadow-2xs">
                {!currentLesson.completed ? (
                  <>
                    {/* Background content blurred */}
                    <div className="absolute inset-0 flex flex-col p-4 filter blur-[2px] pointer-events-none opacity-50">
                      <div className="flex gap-3 mb-4">
                        <div className="w-8 h-8 rounded-full bg-slate-200 shrink-0" />
                        <div className="flex-1 h-8 rounded-xl bg-slate-100" />
                      </div>
                      ...
                      <div className="flex flex-col items-center border-t border-slate-100 pt-4">
                        ...
                        <div className="h-3 w-28 bg-slate-100 rounded-sm mb-1.5" />
                        <div className="h-2 w-44 bg-slate-50 rounded-sm" />
                      </div>
                    </div>
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center animate-fade-in">
                      ...
                      <h4 className="font-extrabold text-sm text-slate-900 tracking-wide uppercase">Discussion Locked</h4>
                      <p className="text-xs font-semibold text-slate-500 mt-2 max-w-[240px] leading-relaxed">
                        Lesson discussions will unlock after you complete this video.
                      </p>
                    </div>
                  </>
                ) : (
                  <div className="absolute inset-0 flex flex-col p-4 text-left select-text pointer-events-auto overflow-y-auto">
                    <div className="flex gap-3 mb-4">
                      <Avatar name="New Student" size="sm" />
                      <div className="flex-1 space-y-2">
                        <textarea placeholder="Ask a question or share your thoughts..." className="w-full px-3 py-2 rounded-xl bg-slate-50 border border-slate-200 focus:border-[#7c3aed] focus:ring-2 focus:ring-purple-100 outline-none text-xs font-semibold text-slate-900 min-h-[70px] resize-none" />
                        <div className="flex justify-end">
                          <button className="px-4 py-2 rounded-xl bg-[#7c3aed] hover:bg-[#6d28d9] text-white text-[10px] font-extrabold shadow-md transition-all cursor-pointer">
                            Post Comment
                          </button>
                        </div>
                      </div>
                    </div>
                    <div className="flex-1 overflow-y-auto space-y-4 pt-4 border-t border-slate-100">
