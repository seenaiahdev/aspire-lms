  ...
  return (
    <div className="max-w-4xl mx-auto py-20 px-6 font-sans">
      <div className="rounded-3xl bg-white p-12 shadow-md text-center">
        <h1 className="text-3xl font-extrabold text-slate-900 mb-4">Rewards</h1>
        <p className="text-slate-500 mb-6">We're working on a rewards experience to recognize your progress.</p>
