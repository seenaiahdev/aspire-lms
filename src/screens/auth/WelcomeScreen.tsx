    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-[400px] h-[400px] rounded-full pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(32,178,150,0.2) 0%, transparent 70%)', transform: 'translate(-30%, -30%)' }} />
        {/* Blue glow bottom-right */}
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(30,90,160,0.2) 0%, transparent 70%)', transform: 'translate(30%, 30%)' }} />
        ...
        <div className="relative z-10 max-w-md text-center lg:text-left">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/20 bg-white/10 backdrop-blur-sm mb-6 animate-fade-down">
            <Sparkles className="w-3.5 h-3.5" style={{ color: '#3b52a4' }} />
          ...
          <h1 className="font-bold text-3xl lg:text-4xl text-white leading-tight mb-4 animate-fade-up">
            Master skills that{' '}
            <span style={{ color: '#3b52a4' }}>matter</span>{' '}
            for your future
          </h1>
          ...
          <div className="hidden lg:grid grid-cols-3 gap-4 animate-fade-up">
            {[
              ...
              <div key={i} className="text-center">
                <s.icon className="w-5 h-5 mx-auto mb-2" style={{ color: '#3b52a4' }} />
        ...
        <div className="w-full max-w-sm animate-fade-up">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="font-bold text-xl text-gray-900">
              Aspire<span style={{ color: '#3b52a4' }}>Next</span>
            </span>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-semibold text-white text-sm transition-all duration-150 active:scale-95 shadow-md hover:shadow-lg"
              style={{ background: '#1e2761' }}
              onMouseEnter={e => (e.currentTarget.style.background = '#171e4d')}
              onMouseLeave={e => (e.currentTarget.style.background = '#1e2761')}
            >
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl font-semibold text-sm border-2 border-slate-200 text-slate-700 hover:border-indigo-500 hover:text-indigo-700 transition-all duration-150"
            >
              Create new account
            </button>
          ...
          <p className="text-center text-xs text-gray-400 mt-6">
            ...
            <button className="font-medium hover:underline" style={{ color: '#3b52a4' }}>Terms of Service</button>
            {' '}and{' '}
            <button className="font-medium hover:underline" style={{ color: '#3b52a4' }}>Privacy Policy</button>
          </p>
        </div>
      </div>
    </div>
