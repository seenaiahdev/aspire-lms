...
export function LoginScreen() {
  ...
  return (
    <div 
      ...
      style={{ 
        // 3D Ambient Full-Screen Background in AspireNext Logo Colors (Midnight Navy & Royal Cobalt)
        background: 'radial-gradient(ellipse at 25% 30%, #1e2761 0%, #171e4d 45%, #0c0f26 100%)',
      }}
    >
      ...
      <div className="w-full h-full max-w-7xl mx-auto grid lg:grid-cols-12 gap-8 lg:gap-14 items-center justify-between relative z-10 my-auto py-2">
        ...
        <div className="lg:col-span-7 h-full flex flex-col justify-between items-center lg:items-start text-center lg:text-left text-white py-2 lg:py-4 pr-0 lg:pr-6 shrink-0">
          ...
          <div>
            ...
            <p className="text-indigo-100/90 text-sm sm:text-lg lg:text-xl font-medium tracking-wide">
          ...
          <div className="relative w-full max-w-[280px] sm:max-w-md mx-auto lg:mx-0 mt-6 mb-4 flex items-center justify-center py-2">
            ...
            <div 
              ...
              style={{ background: 'radial-gradient(circle, #3b52a4 0%, #1e2761 70%)' }} 
            />
            ...
            <div className="flex absolute -top-2 -left-5 sm:top-3 sm:-left-4 px-2 py-1 sm:px-3.5 sm:py-1.5 rounded-xl sm:rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 shadow-xl items-center gap-1 sm:gap-2 animate-[float_5s_ease-in-out_infinite] hover:scale-105 transition-transform z-20">
              <Code2 className="w-3 h-3 sm:w-4 sm:h-4 text-indigo-200" />
            ...
            <div className="flex absolute -bottom-2 -right-3 sm:bottom-3 sm:-right-4 px-2 py-1 sm:px-3.5 sm:py-1.5 rounded-xl sm:rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 shadow-xl items-center gap-1 sm:gap-2 animate-[float_5.5s_ease-in-out_infinite_0.5s] hover:scale-105 transition-transform z-20">
              <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#60a5fa] animate-ping" />
          ...
          {/* Bottom Tagline */}
          <p className="text-indigo-100/90 text-xs sm:text-base leading-relaxed max-w-lg font-normal text-center lg:text-left mt-2">
        ...
        <div className="lg:col-span-5 h-full flex items-center justify-center lg:justify-end shrink-0">
          ...
          >
            ...
            <div className="flex flex-col items-center">
              <div className="w-20 h-20 sm:w-24 sm:h-24 max-w-[96px] max-h-[96px] rounded-2xl bg-white shadow-lg flex items-center justify-center p-3 mb-3 border border-white/90 hover:scale-105 transition-transform duration-300 shrink-0">
                <img
                  src={aspireLogo}
                  alt="Aspire Next Logo"
                  className="w-full h-full object-contain max-w-[68px] max-h-[68px]"
                />
              </div>

              {/* AspireNext Signature Underline Accent Line (Midnight Navy, Royal Cobalt & Sky Cobalt Glow) */}
              <div 
                className="w-14 sm:w-16 h-1.5 rounded-full shadow-sm mb-6 sm:mb-8" 
                style={{ background: 'linear-gradient(90deg, #1e2761 0%, #3b52a4 60%, #60a5fa 100%)' }} 
              />
            </div>
            ...
            {step === 'mobile' ? (
              <form onSubmit={handleLoginClick} className="w-full flex flex-col items-center my-auto pt-2 sm:pt-4">
                ...
                <div className="w-full relative mb-5 sm:mb-6 group">
                  ...
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2 flex items-center gap-2 pointer-events-none text-slate-400 z-10">
                    <Phone className="w-4 h-4 text-indigo-600 shrink-0 group-focus-within:text-indigo-700 transition-colors" />
                  ...
                  <input
                    ...
                    className="w-full bg-white rounded-xl py-3.5 sm:py-4 pr-9 text-xs sm:text-sm font-bold text-slate-800 placeholder:text-slate-400 placeholder:font-semibold placeholder:tracking-widest border border-slate-200/80 outline-none focus:bg-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-600 shadow-sm tracking-widest transition-all"
                  />

                  {/* Validation Checkmark */}
                  {mobile.length === 10 && (
                    <div className="absolute right-3.5 top-1/2 -translate-y-1/2 text-indigo-600 z-10 animate-scale-in">
                ...
                <button
                  ...
                  style={{ 
                    background: 'linear-gradient(135deg, #1e2761 0%, #3b52a4 55%, #2563eb 100%)',
                ...
                >
                  {isSubmitting ? (
                    <div className="flex items-center justify-center gap-2.5 animate-fade-in">
                      <span className="w-4 h-4 rounded-full border-2 border-white/20 border-t-white border-r-indigo-300 animate-spin shrink-0 shadow-[0_0_10px_rgba(255,255,255,0.8)]" />
                      <span className="tracking-widest font-bold text-xs sm:text-xs animate-pulse text-indigo-100">
                        SENDING OTP...
                      </span>
                    </div>
                  ) : (
              ...
              <form onSubmit={handleOtpSubmit} className="w-full flex flex-col items-center my-auto animate-fade-in">
                <div className="text-center mb-5">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-100/80 text-indigo-900 text-xs font-medium mb-1.5">
                    <ShieldCheck className="w-4 h-4 text-indigo-600" /> Verification Code
                  </div>
                ...
                <div className="flex gap-2.5 justify-center mb-6">
                  {otp.map((digit, idx) => (
                    <input
                      ...
                      className="w-10 h-12 bg-white rounded-lg border border-slate-300 text-center font-bold text-lg text-slate-800 outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-600 shadow-sm transition-all"
                    />
                  ))}
                </div>
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg, #1e2761 0%, #3b52a4 100%)' }}
                >
                  {isSubmitting ? (
                    <div className="flex items-center justify-center gap-2.5 animate-fade-in">
                      <span className="w-4 h-4 rounded-full border-2 border-white/20 border-t-white border-r-indigo-300 animate-spin shrink-0 shadow-[0_0_10px_rgba(255,255,255,0.8)]" />
                ...
                <button
                  ...
                  className="text-xs font-normal text-indigo-700 hover:underline mt-4"
                >
