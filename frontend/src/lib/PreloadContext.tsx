    ...
    (async () => {
      try {
        ...
        const [
          ...
          supabase.from('recordings').select('title, concept_name, video_url, thumbnail, duration, target_batch, publish_status, instructions').order('created_at', { ascending: false }).limit(60),
