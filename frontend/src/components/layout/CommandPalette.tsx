...
const commands: { id: Route; label: string; icon: any; group: string }[] = [
  ...
  { id: 'daily-assessment', label: 'Daily Assessment', icon: FileText, group: 'Navigation' },
  { id: 'practice', label: 'Practice Lab', icon: Code2, group: 'Navigation' },
  { id: 'weekly-assessment', label: 'Weekly Assessment', icon: ClipboardCheck, group: 'Navigation' },
